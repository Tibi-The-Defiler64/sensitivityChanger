...
namespace WpfApplication6
{
    public static class rawStructs
    {
        ...
        {
            internal short usUsagePage;
            internal short usUsage;
            internal int dwFlags;
            internal IntPtr ThwndTarget;

            public override string ToString()
            {
                return string.Format("{0}/{1}, flags: {2}, target: {3}", usUsagePage, usUsage, dwFlags, ThwndTarget);
            }
        }
        /*
        public struct RAWINPUTDEVICE
